...
function isAllowedEndpoint(string $method, string $path): bool {
    $exact = [
        'GET'  => ['auth/me', 'catalog/interlocutors', 'catalog/locations', 'catalog/skus', 'catalog/roles', 'inventory/stock', 'analytics/kardex', 'production/recipes', 'production/orders', 'system/params', 'health'],
